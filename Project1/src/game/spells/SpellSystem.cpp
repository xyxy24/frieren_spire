...
constexpr std::array Definitions {
    ...
    SpellDefinition {2006U, "Mimic Magic", "Copy the attack-area dimensions of the nearest living enemy within 260 pixels, then release that template in your current facing direction. The copied attack deals at least 60 damage even when the original attack is weaker.", SpellEffect::Mimic, SpellShape::ForwardBox, 0, SpellSystem::UltimateCooldownSeconds, 260.0F, 96.0F, SpellTier::Boss},
