...
$arguments = switch ($Action) {
    ...
    "test-debug" { @("--build", "--preset", $debugBuildPreset, "--target", "arcane_core_tests", "combat_session_tests", "run_flow_tests") }
    "test-release" { @("--build", "--preset", $releaseBuildPreset, "--target", "arcane_core_tests", "combat_session_tests", "run_flow_tests") }
}
